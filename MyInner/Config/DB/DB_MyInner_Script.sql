...
-- -----------------------------------------------------
-- procedure SP_CHECK_EXISTS_USERNAME 
-- -----------------------------------------------------

DELIMITER $$
USE `db_myinner`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CHECK_EXISTS_USERNAME`(_USER_NAME VARCHAR(255)) 
BEGIN 
SELECT TBL_LOGIN.USER_NAME FROM TBL_LOGIN
...
SHOW WARNINGS;
-- -----------------------------------------------------
-- procedure SP_CHECK_EXISTS_EMAIL
-- -----------------------------------------------------

DELIMITER $$
USE `db_myinner`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CHECK_EXISTS_EMAIL`(_EMAIL_USER VARCHAR(255)) 
BEGIN 
SELECT TBL_LOGIN.EMAIL_USER FROM TBL_LOGIN
...
SHOW WARNINGS;
-- -----------------------------------------------------
-- procedure SP_CHECK_EXISTS_CPF
-- -----------------------------------------------------

DELIMITER $$
USE `db_myinner`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CHECK_EXISTS_CPF`(_CPF VARCHAR(255)) 
BEGIN 
SELECT TBL_USER.CPF FROM TBL_USER
WHERE CPF = _CPF ;
END$$
