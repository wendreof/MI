...
DELIMITER $$
USE `db_myinner`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_INSERT_USER`(_NOME_USER VARCHAR(15),_SOBRENOME_USER VARCHAR(15),_CPF VARCHAR(40),_ENDERECO_USER VARCHAR(255),
...
VALUES (_ID_USER,_NOME_USER,_SOBRENOME_USER,_ENDERECO_USER,_CPF,_EMAIL_USER,_SEXO_USER,_CIDADE_USER,_ESTADO_USER,_PAIS_USER,_DATANASC_USER,_ROLE_USER,_USER_NAME,_CHECKBOXCONTRATO);
END$$
